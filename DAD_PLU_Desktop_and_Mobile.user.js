...
// @downloadURL  https://github.com/MohsenUSA/product_lookup/blob/main/DAD_PLU_Desktop_and_Mobile.user.js
// @updateURL    https://github.com/MohsenUSA/product_lookup/blob/main/DAD_PLU_Desktop_and_Mobile.user.js
// ==/UserScript==
    ...
    function scanPage() {
      ...
      const popupCSS = `
        ...
        .availability {
          ...
          width:90%; padding:5px; color:#fff;
